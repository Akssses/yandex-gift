...
const GiftContent10 = () => {
  const downloadLink = "https://disk.360.yandex.ru/i/s90v9jqMVp1xgQ";
      ...
      <div className={styles.xyi}>
        <div className={styles.giftPageContent}>
          <div className={styles.giftPageTitle}>
            Самое время добавить киномагии
          </div>
          <div className={styles.giftPageSubtitle}>
            Лучший план на вечер: горячий напиток и новогодний фильм. Мы собрали
            подборку картин от Кинопоиска: тёплых, смешных и очень зимних.
            Выбери фильм, который сделает вечер чуть уютнее!
          </div>
